    ...
    return (
        <aside className="w-[350px] p-3">
            ...
            <div>
                ...
                <input type="text" placeholder='add custom filters' className='p-4 w-full border rounded-md placeholder-[#0074CC] border-gray-300 focus:outline-none focus:border-blue-500' />
